        ...
        this.isShown &&
          ...
          !(
            ...
            : A(this.player.getElementsByTagName("img"), function (t) {
                X(t, y, e.loadImage.bind(e), { once: !0 }), q(t, y);
              }));
      },
      wheel: function (t) {
        var e,
            ...
            !1 !== q(r, "hide") &&
              ...
              l.transition && !a
                ? ((n = function (t) {
                  ...
                  (this.transitioning = {
                    abort: function () {
                      s.viewed && L(t, m) ? Y(t, k, o) : L(e, m) && Y(e, k, n);
                    },
                  }),
                  this.viewed && L(t, m)
                    ? (X(t, k, o, { once: !0 }),
          ...
          (o.rotate = t),
            ...
            this.renderImage(function () {
              (e.rotating = !1),
                ...
                q(i, lt, { degree: t, oldDegree: s }, { cancelable: !1 });
            });
        }
        return this;
      },
      ...
      zoomTo: function (t) {
        ...
        if (
          ...
          if (
            ...
            !1 === q(h, "zoom", { ratio: t, oldRatio: x, originalEvent: r }))
          )
            return this;
          (this.zooming = !0),
            r
            ...
            !1 !== q(t, "play") &&
              ...
              ((e = function () {
                clearTimeout(n.playing.timeout),
                  M(r[h], u),
                  R(r[(h = 0 <= --h ? h : l - 1)], u),
                  (n.playing.timeout = setTimeout(e, o.interval));
              }),
              (i = function () {
                clearTimeout(n.playing.timeout),
                  M(r[h], u),
                  R(r[(h = (h += 1) < l ? h : 0)], u),
                  (n.playing.timeout = setTimeout(i, o.interval));
              }),
              1 < l)) &&
            (this.playing = {
              prev: e,
        ...
        (e = [
          {
            ...
            value: function () {
              ...
              s[g] ||
                ...
                (e = []),
                A(
                  (t = "img" === s.localName) ? [s] : s.querySelectorAll("img"),
                  function (t) {
                    I(a.filter)
